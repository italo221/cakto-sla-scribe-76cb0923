...
const getPriorityConfig = (priority: string) => {
  const configs = {
    P0: { color: "bg-red-100 text-red-700 border-red-200", label: "Crítico" },
    P1: { color: "bg-orange-100 text-orange-700 border-orange-200", label: "Alto" },
    P2: { color: "bg-yellow-100 text-yellow-700 border-yellow-200", label: "Médio" },
    P3: { color: "bg-blue-100 text-blue-700 border-blue-200", label: "Baixo" }
  };
