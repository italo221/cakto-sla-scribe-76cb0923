-- Corrigir problemas de segurança: adicionar SET search_path para as funções

-- 1. Atualizar função para notificação de mudança de status
...
-- 2. Atualizar função para notificação de transferência de setor
