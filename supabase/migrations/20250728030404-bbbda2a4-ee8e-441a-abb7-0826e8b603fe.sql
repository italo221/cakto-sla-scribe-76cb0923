-- Corrigir o trigger de validação de role para referenciar corretamente a tabela profiles
...
BEGIN
  ...
  IF OLD.role != NEW.role THEN
    ...
    -- Log da alteração sensível (corrigindo a referência à tabela profiles)
